...
const TEMPLATE_DB = {
  ...
  templates: [
    ...
    },
    {
      ...
      category: "image",
      badge: "HOT",
      title: "服飾 AI 模特 · 平拍轉實穿圖",
      subtitle: "Fashion AI Model — Flat Lay to Try-On",
      desc: "把上衣、洋裝、外套等平拍照片轉成模特實穿情境圖，適合服飾賣家快速補齊商品頁與社群視覺。",
      tags: ["服飾模特","商品情境","社群封面"],
      platforms: ["蝦皮","小紅書","Instagram"],
      ratio: "4:5 / 1:1",
      level: "進階",
      uses: 860,
      preview_gradient: "linear-gradient(135deg,#eff5ff 0%,#dbe8ff 52%,#bcd4ff 100%)",
      preview_icon: "◐",
      preview_color: "#2f66f4",
      prompt_hint: "fashion model wearing the uploaded clothing item, clean ecommerce studio, natural pose, premium catalog photography",
      copy_template: "服飾品類 + 目標客群 + 想要的模特氣質 + 背景風格 + 平台比例",
      href: "/fashion/",
      button_label: "前往服飾 AI 模特",
    },
    {
      id: "img-004",
      category: "image",
